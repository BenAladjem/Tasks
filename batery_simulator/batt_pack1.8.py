# Работеща версия. Няма поверка за непопълнени полета!
...
class FC():
    AVG_CURRENT_CONSUMPTION_REPORT = 99.6  # mA
    AVG_CURRENT_CONSUMPTION_SLEEP = 0.311  # mA
    AVG_CURRENT_CONSUMPTION_WORK = 12.6  # Не е измерена, само за проба

...
class BatteryPowered:
    ...
    def calculate_time(self):
        ...
        return TimeConverting.time_convert(time)
...
def print_something():
    ...
    report_time = float(txt2.get())
    work_time = float(txt3.get())
    sleep_time = float(txt4.get())
    ...
    lbl27.configure(text=dev.calculate_time())
    lbl28.configure(text=dev.calculate_iterations())
